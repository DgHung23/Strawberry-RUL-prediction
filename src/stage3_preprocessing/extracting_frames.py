...
video_folder = PROJECT_ROOT / "data" / "2026-03-21" # can change to 19-03-2026 or 21-03-2026 bla bla... depending on the date of the video
script_dir = os.path.dirname(os.path.abspath(__file__))
date_part = PROJECT_ROOT / "data" / "01_raw" / "21-03-2026" # create folder with the name of the date part to save frames, can change to 19-03-2026 or 21-03-2026 bla bla... depending on the date of the video
sample_minutes = 15 # 5 minutes of sampling, can adjust if want to save more or less frames per second bla bla...

output_folder = os.path.join(script_dir, str(date_part))
