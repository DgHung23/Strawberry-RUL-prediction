"""Tuned training script for Model C.
...
Outputs are written separately from the original Model C run:

- models/model_C_tuned/best_model.pth
- data/model_C_tuned_outputs/training_history.csv
- data/model_C_tuned_outputs/test_predictions.csv
- data/model_C_tuned_outputs/metrics.json
"""
...
def train(args: argparse.Namespace) -> dict[str, float]:
    ...
    models_dir = project_root / "models" / f"model_C_{run_name}"
    outputs_dir = project_root / "data" / f"model_C_{run_name}_outputs"
    ...
    metrics = {
        "model": f"Model_C_{run_name}_EfficientNet-B0_CBAM_LSTM",
        "run_name": run_name,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train tuned Model C for strawberry RUL.")
